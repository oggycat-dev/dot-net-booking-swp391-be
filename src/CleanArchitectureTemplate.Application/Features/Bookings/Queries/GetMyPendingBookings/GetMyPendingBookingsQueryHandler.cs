...
public class GetMyPendingBookingsQueryHandler : IRequestHandler<GetMyPendingBookingsQuery, List<BookingDto>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly ICurrentUserService _currentUserService;

    public GetMyPendingBookingsQueryHandler(
    ...
    public async Task<List<BookingDto>> Handle(GetMyPendingBookingsQuery request, CancellationToken cancellationToken)
    {
        ...
        // Get all pending bookings created by this user
        var bookings = await _unitOfWork.Bookings.GetMyPendingBookingsAsync(userId);
